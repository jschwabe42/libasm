...
gcc -Wall -Wextra -Werror -g ${ARCH} -c atoi_base_main.c -o main.o
gcc -Wall -Wextra -Werror -g ${ARCH} main.o ft_atoi_base.o ft_strcpy.o ft_strdup.o ft_strlen.o -o test_atoi_base.out